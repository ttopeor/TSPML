...
class PickObservationManager(ObservationManager):
    ...
    def object_desired_positions(self, env: PickEnv):
        """Desired object position."""
        return env.object_des_pose_w[:, 0:3] - env.envs_positions

    def object_desired_orientations(self, env: PickEnv):
...
class PickRewardManager(RewardManager):
    def reaching_object_position_l2(self, env: PickEnv):
    ...
    def reaching_object_position_exp(self, env: PickEnv, sigma: float):
    ...
    def tracking_object_position_exp(self, env: PickEnv, sigma: float, threshold: float):
    ...
    def tracking_object_position_tanh(self, env: PickEnv, sigma: float, threshold: float):
